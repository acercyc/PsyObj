function d = randPMF(yPMF, n, xPMF)

% d = randPMF(yPMF, n, xPMF)
% yPMF: pdf 
% n: number of random sample. e.g. [1 10]; [10 10]
% xPDF: index of PMF; can be omitted
% 
% modify gendist.m by Tristan Ursell, (c) 2012
%
%
% 1.0 - Acer 2014/06/13 13:43
%======================================================================%

if numel(n) == 1; n = [n, n]; end
N = n(1);
M = n(2);
if iscolumn(yPMF); yPMF = yPMF'; end

d = gendist(yPMF,N,M);

if exist('xPMF', 'var')
   d = reshape(xPMF(d), N, M);
end
